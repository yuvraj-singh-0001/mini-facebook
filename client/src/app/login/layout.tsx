...
export const metadata: Metadata = {
  ...
  description:
    "Log in to Vaaknow (vaaknow.in) — the safe, moderated social platform for students aged 6–16. Access your Birdies, Chirps, and Reels in a cyberbullying-free environment.",
  keywords: [
    "Vaaknow login",
    "Vaaknow sign in",
    "vaaknow.in login",
